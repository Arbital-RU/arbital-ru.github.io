...
Для некоторых примеров концептуально иллюстрирующего кода, которому нужен был бы гиперкомпьютер для реального запуска, см. [индукцию Соломонова][solomonoff_induction] и [AIXI][AIXI].
